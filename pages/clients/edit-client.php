    ...
    <div class="card-body">
        ...
        <form method="POST" action="" id="clientForm">
            ...
            <div style="margin-bottom: 2rem;">
                <h4 style="margin-bottom: 1rem; color: var(--gray-600);" id="companyInfoTitle">🏢 Информация о компании
                </h4>
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="clientType" class="form-control" required>
                            <option value="wholesale" <?= $client['type'] === 'wholesale' ? 'selected' : '' ?>>
                                <?= __('wholesale') ?>
                            </option>
                            <option value="retail" <?= $client['type'] === 'retail' ? 'selected' : '' ?>>
                                <?= __('retail') ?>
                            </option>
                        </select>
                    </div>
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <div class="form-row">
                    <div class="form-group" id="legalAddressGroup" style="flex: 1;">
                        ...
                        <textarea name="legal_address" id="legalAddress" class="form-control"
                    ...
                    <div class="form-group" id="warehouseAddressGroup" style="flex: 1;">
                        ...
                        <textarea name="warehouse_address" id="warehouseAddress" class="form-control"
                        ...
                        <tbody>
                            <?php foreach ($salesHistory as $s): ?>
                                <tr>
                                    ...
                                    <td><?= e($s['invoice_number'] ?: 'N/A') ?></td>
                                    <td><?= $s['items_count'] ?></td>
                                    <td><?= number_format($s['vat_amount'], 2, '.', ' ') ?> CZK</td>
                                    <td><strong><?= number_format($s['total'], 2, '.', ' ') ?> CZK</strong></td>
                                    <td><span class="badge badge-gray"><?= e($s['status'] ?: 'Done') ?></span></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
...
<script>
    ...
    function updateUIForType() {
        ...
        const sameContactWrapper = sameContactCheckbox.closest('div').closest('div'); // label.form-check wrapper

        if (!isWholesale) {
            warehouseSection.style.display = 'none';
            document.getElementById('sameContact').closest('.form-check').parentElement.style.display = 'none';
            ...
            document.getElementById('sameContact').closest('.form-check').parentElement.style.display = 'block';
